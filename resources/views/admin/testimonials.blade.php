            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <button type="button" class="btn btn-sm btn-primary shadow-sm float-right add" ><i class="fa fa-plus-circle"></i> Testimonial</button>
                    </div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"><i class="fa fa-plus-circle"></i> Testimonial</h4>
                ...
                <div class="modal-body">
                    <form class="form" id="add_form" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="edit_feedback" class="control-label">Feedback</label>
                            <input type="text" class="form-control" name="feedback" id="edit_feedback">
                        </div>
                        <div class="form-group">
